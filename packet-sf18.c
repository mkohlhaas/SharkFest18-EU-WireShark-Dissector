/* packet-sf18.c
 * Routines for sf18 dissection
 * Copyright 2018, Graham Bloice <graham.bloice at trihedral.com>
 *
 ...
 * 51 Franklin Street, Fifth Floor, Boston, MA 02110-1401 USA.
 */
...
dissect_sf18(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
    ...
    if (try_val_to_str(func_code, sf18_func_vals) == NULL)
        return 0;
    ...
    col_add_str(pinfo->cinfo, COL_INFO,
                val_to_str(func_code, sf18_func_vals, "Unknown function (%d)"));
            ...
            if (func_code == FUNC_REQ_REPLY) {
                switch (data_id)
                {
                    ...
                    case READ_LONG:
                        ...
                        break;
                    case READ_STRING:
                        proto_tree_add_item(sf18_tree, hf_sf18_Data_String, tvb, offset, 15, ENC_LITTLE_ENDIAN);
                        offset += 15;
                        break;
                    default:
                        break;
